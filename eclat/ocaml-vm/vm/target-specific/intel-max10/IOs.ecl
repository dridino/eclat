...
type switch = bool ;;
type key = bool ;;
type accelerometer_in = bool * bool ;; (* GSENSOR_INT *)
type accelerometer_out = std_logic * bool ;; (* GSENSOR_CS_N * GSENSOR_SCLK *)
type accelerometer_inout = std_logic * std_logic ;; (* GSENSOR_SDO * GSENSOR_SDI *)
type sync = bool ;;
type channel = int<4> ;;
type vga = sync * sync * channel * channel * channel ;;
...
type inputs = switches * keys * accelerometer_in * accelerometer_inout ;;

type outputs = leds * t_7segs * accelerometer_out * accelerometer_inout * vga ;;

type inouts = accelerometer_inout ;;
